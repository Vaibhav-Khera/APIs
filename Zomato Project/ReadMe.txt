...
Extract using the following url and stored in CSV file - https://drive.google.com/file/d/1FSa_x3COvCoMODa44qXufO9CQb3ydqKw/view

In this project using API we found out the answers to some interesting questions and plotted their graphs for visual analysis of the results.
